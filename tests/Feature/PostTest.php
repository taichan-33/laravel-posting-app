...
class PostTest extends TestCase
{
    ...
    public function test_quest_cannot_access_posts_show()
    {
        $user = User::factory()->create();
        $post = Post::factory()->create(['user_id' => $user->id]);
    ...
    public function test_quest_cannot_access_Posts_create()
    {
    ...
    public function test_quest_cannot_access_posts_store()
    {
        $post = [
            'title' => 'プログラミング学習1日目',
    ...
    public function test_quest_cannot_access_posts_edit()
    {
        $user = User::factory()->create();
        $post = Post::factory()->create(['user_id' => $user->id]);
    ...
    // 未ログインのユーザーは他人の編集ページにアクセスできない
    public function test_user_cannot_access_others_posts__edit()
    {
        $user = User::factory()->create();
    ...
    //未ログインユーザーは投稿を更新できない
    public function test_quest_cannot_update_post()
    {
        $user = User::factory()->create();
    ...
    public function test_quest_cannot_destroy_post()
    {
        $user = User::factory()->create();
        $post = Post::factory()->create(['user_id' => $user->id]);
